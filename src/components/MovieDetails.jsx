        ...
        ">
                ...
                >
                    ...
                    >
                        ...
                        <p>
                            Produced by:
                            {details.production_companies && details.production_companies.map((company, index) => {
                                return (
                                    <span key={company.id} className='ml-2 text-blue-500'>
                                        {company.name}{index === details.production_companies.length - 1 ? '.' : ','}
                                    </span>
                                );
                            })}
                        </p>
                        ...
                        <p>
                            ...
                            {details.production_countries && details.production_countries.map((country, index) => {
                                return (
                                    <span key={country.iso_3166_1} className='ml-2 text-blue-500'>
                                        {country.name}{index === details.production_countries.length - 1 ? '.' : ','}
                                    </span>
                                );
                            })}
                        </p>
                ...
                <div className='my-8 space-y-8 px-4 md:flex md:flex-row
                ...
                '>
                    ...
                    <div className='md:w-1/2'>
                        ...
                        <p className='mt-2 text-base font-medium'>
                            <span className='font-semibold'>Language:</span> {details.original_language}
                        </p>
                        <p className='mt-2 text-base font-medium'>
                            <span className='font-semibold'>Rating:</span> {details.vote_average}
                        </p>
                        <p className='mt-2 text-base font-medium'>
